...
public class RegisterCompanyPanel extends JPanel {
    ...
    public RegisterCompanyPanel ( final RegisterScreen registerScreen ) {
        ...
        registerButton.addActionListener(e -> {
            ...
            //Ensure companies are refreshed to assign people to companies.
            registerScreen.dispose();
            RegisterScreen registerScreen2 = new RegisterScreen(registerScreen.getUserInterface(), registerScreen.getUserInterface().getRegisterScreenConfig());
            registerScreen2.enablePersonTab();
        });
