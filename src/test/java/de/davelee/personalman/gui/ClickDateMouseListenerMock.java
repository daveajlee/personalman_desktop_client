...
public class ClickDateMouseListenerMock extends ClickDateMouseListener {
	 ...
	 */
	public ClickDateMouseListenerMock ( final UserInterface userInterface, final LocalDate localDate, final String company, final String username, final MonthPanel monthPanel ) {
		super(userInterface, localDate, company, username, monthPanel);
	}
